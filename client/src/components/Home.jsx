...
export default function Home() {
  ...
  const drinks = [
    ...
    { id: 8, name: 'Strawberries Juice', price: 4.0, image: 'https://pickyeaterblog.com/wp-content/uploads/2022/09/strawberry-juice-1.jpg' },
    ...
    <div>
      ...
      <div className="menu">
        <ul className="menu-list">
          {!isAuthenticated ? (
            <li>
              <a href="#" onClick={loginWithRedirect} className="btn-primary">
                Login
              </a>
            </li>
          ) : (
          ...
          <li>
            <a href="#" onClick={signUp} className="btn-secondary">
              Create Account
            </a>
          </li>
  
          <li>
            <Link to="/cart" className="btn-secondary" onClick={order}>
              Order
            </Link>
          </li>
          ...
          <li>
            ...
            <img src="https://www.clker.com//cliparts/X/U/F/3/N/2/shopping-cart-logo.svg.hi.png" alt="Cart" 
